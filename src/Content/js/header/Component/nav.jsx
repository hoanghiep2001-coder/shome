...
function Navigation() {
  ...
  return (
    <>
      <div className={cb("d-lg-flex", "align-items-lg-center", context.webResponsiveStyle)}>
        <ul className="nav">
        ...
        <div className="header__user">
          <div className="header__user-link">
            <FaRegUserCircle onClick={() => setModalShow(true)} fontSize={36} color="orange" className="ms-4 header__user-img" />
          </div>
        </div>
      </div>
