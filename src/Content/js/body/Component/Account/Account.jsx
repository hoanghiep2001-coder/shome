  ...
  return (
    ...
    >
      ...
      >
            ...
            <div className={cb("info-item")}>
              <div className={cb("table")}>
                <div className={cb("table-cell")}>
                  ...
                  <div className={cb("btn")} onClick={handleContainerFormClick}>
                    Sign up
                  </div>
                </div>
              </div>
        ...
        <a className={cb("box-item")} href="" target="_blank">
          <svg className={cb("rabbit")} version="1.2" viewBox="0 0 600 600">
            <path
